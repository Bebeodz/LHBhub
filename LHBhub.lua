...
local Fluent = loadstring(game:HttpGet("https://raw.githubusercontent.com/Bebeodz/LHB-Hub-/main/LHBhub.lua"))()
...
local Tabs = {
	...
	Kitsune = Window:AddTab({ Title = "Tab Kitsune", Icon = "false" })
}
...
elseif Lv == 100 or Lv <= 119 or SelectMonster == "Snowman" or  lectArea == 'Snow' then -- Snowman
Ms = "Snowman"
NameQuest = "SnowQuest"
QuestLv = 2
NameMon = "Snowman"
